...
export default function Footer() {
  return (
    <footer className="bg-celo-yellow text-celo-black">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          ...
          <div>
            ...
            <div className="flex gap-2 mb-4">
              <input
                type="email"
                placeholder="Email"
                className="flex-1 px-4 py-3 rounded-lg border border-celo-black bg-white text-celo-black placeholder-celo-gray-500 focus:outline-none focus:ring-2 focus:ring-celo-lime"
              />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="#" className="block px-2 py-1 bg-transparent border border-celo-black rounded-full text-xs font-bold hover:bg-celo-black hover:text-celo-yellow transition-colors text-center whitespace-normal">
                  Desarrolladores
                </a>
                <a href="#" className="block px-2 py-1 bg-transparent border border-celo-black rounded-full text-xs font-bold hover:bg-celo-black hover:text-celo-yellow transition-colors text-center whitespace-normal">
                  IA
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-8 border-t border-celo-black">
          {/* Social Media Icons */}
          <div className="flex gap-3">
            <a href="#" className="w-10 h-10 bg-celo-yellow border border-celo-black rounded-full flex items-center justify-center hover:bg-celo-gray-100 transition-colors">
